...
export default (app: Router) => {
    ...
    //* GET CALLS
    route.get('/test', checkAuth, async (req: Request, res: Response, next: NextFunction) => {
    ...
    route.get('/exists', checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
          const query = `
          MATCH (n:User {id:"${req.body.id}"})
    ...
    route.get('/usernameexists', checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
          const query = `
    ...
    route.get('/recommend', checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
          const max: number = +req.query.max || 10;
          const offset: number = +req.query.offset || 0;
    ...
    route.get('/locRecommend',checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
          const max: number = +req.query.max || 10;
          const offset: number = +req.query.offset || 0;
    ...
    route.get('/compatibleUsers',checkAuth, async (req: Request, res: Response, next: NextFunction)=> {
        try {
          const session = db.session({ database: "neo4j" });
          const max: number = +req.query.max || 10;
          const offset: number = +req.query.offset || 0;
    ...
    route.get('/interests',checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
          const query1 = `
          MATCH (n:User{id:"${req.body.id}"})
    ...
    route.post('/createInterests', checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
    ...
    //* PUT CALLS
    route.put('/', checkAuth, async (req: Request, res: Response, next: NextFunction) => {
        try {
          const session = db.session({ database: "neo4j" });
    ...
    //* DELETE CALLS
    route.delete('/', checkAuth, async(req: Request, res: Response, next: NextFunction)=> {
        try {
          const session = db.session({ database: "neo4j" });
          const query = `
          MATCH (u:User {id: "${req.body.id}"})
